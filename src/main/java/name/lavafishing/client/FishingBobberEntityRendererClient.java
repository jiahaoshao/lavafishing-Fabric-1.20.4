...
//
package name.lavafishing.client;
...
public class FishingBobberEntityRendererClient extends EntityRenderer<FishingBobberEntity> {
    ...
    public FishingBobberEntityRendererClient(EntityRendererFactory.Context context) {
        super(context);
    }
    ...
    public void render(FishingBobberEntity fishingBobberEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        ...
        if (playerEntity != null) {
            ...
            FishingBobberEntityRendererClient.vertex(vertexConsumer, matrix4f, matrix3f, i, 0.0F, 0, 0, 1);
            FishingBobberEntityRendererClient.vertex(vertexConsumer, matrix4f, matrix3f, i, 1.0F, 0, 1, 1);
            FishingBobberEntityRendererClient.vertex(vertexConsumer, matrix4f, matrix3f, i, 1.0F, 1, 1, 0);
            FishingBobberEntityRendererClient.vertex(vertexConsumer, matrix4f, matrix3f, i, 0.0F, 1, 0, 0);
            matrixStack.pop();
            int j = playerEntity.getMainArm() == Arm.RIGHT ? 1 : -1;
            ItemStack itemStack = playerEntity.getMainHandStack();
            if (!itemStack.isOf(LavafishingItems.OBSIDIAN_FISHING_ROD)) {
                j = -j;
            }
            ...
            for(int z = 0; z <= 16; ++z) {
                FishingBobberEntityRendererClient.renderFishingLine(v, w, x, vertexConsumer2, entry2, FishingBobberEntityRendererClient.percentage(z, 16), FishingBobberEntityRendererClient.percentage(z + 1, 16));
            }
